    ...
    <div className="pagina">
      <header className="header">
        ...
        <a className="cart-button" href="/carrito">
          <img src={carritoIcon} alt="Abrir carrito" />
        </a>
      </header>
      ...
      <main className="body">
        ...
        <p className="body-intro text-below-carrusel">Para comprar o gestionar tu carrito, entra al icono del carrito en el encabezado.</p>
